...
function NextTimerScore() {
    ...
    useEffect(() => {
        ...
        var year = new Date(current.getFullYear(), 4, 1);
        var daysOfYear = Math.floor((current - year) / (24 * 60 * 60 * 1000));
        ...
        let interval = setInterval(function () {
            ...
            if (timeLeft >= 0) {
                ...
                if (lastMinute !== minutes) {
                    const resultDetailed = days + " giorni " + hours + " ore " + minutes + " minuti ";
