         ...
         <div className="pointer-events-auto modal max-w-screen-xs w-full mx-auto top-20 relative rounded-sm" role="dialog" aria-modal="true">
            <div className="bg-custom-bg border border-custom-mg p-6 rounded">
               ...
               <div className="text-center">
                  ...
                  <p className="mb-3">
                     <a href="https://twitter.com/HeardleIta" className="flex items-center no-underline" target="_blank" rel="noreferrer">
                  ...
                  <p className="mb-3">
                     <a href="https://ko-fi.com/X8X4ELG6W" className="flex items-center no-underline" target="_blank" rel="noreferrer">
                        <svg className="mr-1" xmlns="http://www.w3.org/2000/svg" width="20" height="16" viewBox="0 0 24 22" fill="currentColor">
